...
// Module Instance Action Types - 모듈 인스턴스 독립 관리용
const ModuleInstanceActionTypes = {
  REGISTER_MODULE_INSTANCE: "REGISTER_MODULE_INSTANCE",
  UNREGISTER_MODULE_INSTANCE: "UNREGISTER_MODULE_INSTANCE",
  EXECUTE_MODULE_ACTION_REQUEST: "EXECUTE_MODULE_ACTION_REQUEST",
  EXECUTE_MODULE_ACTION_INIT: "EXECUTE_MODULE_ACTION_INIT",
  EXECUTE_MODULE_ACTION_SUCCESS: "EXECUTE_MODULE_ACTION_SUCCESS",
  EXECUTE_MODULE_ACTION_ERROR: "EXECUTE_MODULE_ACTION_ERROR",
  EXECUTE_MODULE_JS_FUNCTION_INIT: "EXECUTE_MODULE_JS_FUNCTION_INIT",
  EXECUTE_MODULE_JS_FUNCTION_SUCCESS: "EXECUTE_MODULE_JS_FUNCTION_SUCCESS",
  EXECUTE_MODULE_JS_FUNCTION_ERROR: "EXECUTE_MODULE_JS_FUNCTION_ERROR",
  UPDATE_MODULE_INSTANCE_DATA: "UPDATE_MODULE_INSTANCE_DATA",
  CLEAR_MODULE_INSTANCE_DATA: "CLEAR_MODULE_INSTANCE_DATA",
  // Input/Output 관련 액션
  UPDATE_MODULE_INSTANCE_INPUT: "UPDATE_MODULE_INSTANCE_INPUT",
  UPDATE_MODULE_INSTANCE_INPUTS: "UPDATE_MODULE_INSTANCE_INPUTS",
  UPDATE_MODULE_INSTANCE_OUTPUTS: "UPDATE_MODULE_INSTANCE_OUTPUTS",
};
...
const WidgetCanvasActionTypes = {
  ...
  RESTORE_MODULE_WIDGETS: "RESTORE_MODULE_WIDGETS", // 평가 트리거 없이 모듈 위젯 복원
